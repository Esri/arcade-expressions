...
// Type: Calculation
// Name: Junction - Auto Contain By Rules
// Description: Auto contain pipeline junctions. Uses the rule table to contain feature in a container within a search distance
// Subtypes: All
// Field: assetid
...
// ** Implementation Note: Adjust these values to match your geodatabase.  The values defined below are for a Version 4
//    utility network with only the schema provide(no additional domain networks)
//    These values will change with a version 3 utility network or if you applied more than one domain to the same utility network.
...
function class_id_to_name(id) {
    ...
    if (Text(id) == "1") {
        ...
        return "System Junction";
    } else if (Text(id) == "3") {
        return "System Junction Object";
    } else if (Text(id) == "4") {
        return "Structure Junction";
    } else if (Text(id) == "5") {
        return "Structure Line";
    } else if (Text(id) == "6") {
        return "Structure Boundary";
    } else if (Text(id) == "7") {
        return "Structure Junction Object";
    } else if (Text(id) == "8") {
        return "Structure Edge Object";
    } else if (Text(id) == "9") {
        ...
        return "Pipeline Junction";
    } else if (Text(id) == "13") {
        return "Pipeline Subnet Line";
    } else if (Text(id) == "14") {
        return "Pipeline Junction Object";
    } else if (Text(id) == "15") {
        return "Pipeline Edge Object";
    } else {
        return Text(id);
    }
}
