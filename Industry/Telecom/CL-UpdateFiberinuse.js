...
var assigned_to_field = $feature.fiberinuse;
...
var fiber_inuse_sql = 'assettype = 163 and strandstatus = 2';
...
return {"result": get_features_counts_by_query(associated_ids, fiber_inuse_sql)};
