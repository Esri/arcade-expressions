...
// Type: Calculation
// Name: Populate fiberdedicated
// Description: Calculates number of Fiber features contained within feature with status of dedicated
// Subtypes: All
// Field: fiberdedicated
// Trigger: Update
...
var fiber_dedicated_sql = 'assettype = 163 and strandstatus = 4';
...
return {"result": get_features_counts_by_query(associated_ids, fiber_dedicated_sql)};
