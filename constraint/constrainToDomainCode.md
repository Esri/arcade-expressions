...
Simple version, does not check subtypes
```js
// Assigned To:
// Type: Validation
// Name: Validate Fields with Domains - No Subtypes
// Description: Validate values on fields with domains
// Subtypes: All
// Error Number: 5003
// Error Message: Error
// Severity: 4
...
// ** Implementation Note: This rule checks one scenario
//      If a domain is applied to a field, ensure the value is valid for domain. This will check every field on $feature.
//      You must adjust the assigned_to_class variable
...
// The Assigned To Class class name
