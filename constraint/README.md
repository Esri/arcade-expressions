...
This folder contains Arcade expression templates and functions that may be used in the [constraint profile](https://developers.arcgis.com/arcade/guide/profiles/#constraint).
...
> Note that expressions living in this folder don't have to be exclusively used in the constraint profile. They can likely be used in different profiles, though they were originally designed for the constraint profile.
