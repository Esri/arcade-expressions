...
This folder contains Arcade expression templates and functions that may be used in the [visualization profile](https://developers.arcgis.com/arcade/guide/profiles/#visualization).
