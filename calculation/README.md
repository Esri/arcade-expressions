...
This folder contains Arcade expression templates and functions that may be used in the [calculation profile](https://developers.arcgis.com/arcade/guide/profiles/#calculation).
